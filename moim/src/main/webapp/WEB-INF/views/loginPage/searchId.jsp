  ...
  <body>
    ...
    <section class="hero">
      <div class="container text-center">
        ...
        <h1 class="hero-heading">SEARCH ID</h1>
        <div class="row">
          <div class="col-lg-7 mx-auto">
            <p class="lead text-muted mt-2">가입했던 아이디를 잊어버리셨나요?</p>
          </div>
        </div>
      </div>
    </section>
            ...
            <div id="accordion" class="faq accordion accordion-custom pb-5">
              ...
              <div class="card">
                <div id="headingOne" class="card-header">
                  <h4 class="mb-0 accordion-heading">
                    <button data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="d-flex align-items-center"><i class="icon-light-bulb"></i><span>핸드폰 번호로 찾기</span></button>
                  </h4>
                </div>
              ...
              <div class="card">
                <div id="headingTwo" class="card-header">
                  <h4 class="mb-0 accordion-heading">
                    <button data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="d-flex align-items-center collapsed"><i class="icon-plug"></i><span>이메일로 찾기</span></button>
                  </h4>
                </div>
