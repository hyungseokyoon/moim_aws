...
public class Join implements java.io.Serializable {
	...
	public Join(int join_num, int team_num, int user_no, String join_intro, String join_original_filename,
	...
	public String toString() {
		return "Join [join_num=" + join_num + ", team_num=" + team_num + ", user_no=" + user_no + ", join_intro="
